...
<div id="center" class="addresses">
    <div class="inner">
        {if $sShippingAddresses}
            <h2>{se name="SelectShippingHeader"}{/se}</h2>
        ...
        {block name="frontend_account_select_shipping_action_buttons"}
            <a class="btn neutral" href="{if $sTarget}{url controller=$sTarget}{else}{url controller='account'}{/if}" title="{s name='SelectShippingLinkBack'}{/s}">
