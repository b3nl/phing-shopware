	    ...
	    <div class="inner">
            ...
            {if $voteConfirmed == false || $sStatus.code == 0}
                <div class="contact_box register">
                    ...
                    <form action="{url controller='newsletter'}" method="post" id="letterForm" class="form newsletter">
                        <fieldset>
                            ...
                            {if {config name=NewsletterExtendedFields}}
                                <div id="sAdditionalForm">
                                    ...
                                    <div class="form_row">
                                        ...
                                        <input name="streetnumber" type="text"  id="streetnumber" value="{$_POST.streetnumber|escape}"  maxlength="5" class="streetnumber text {if $sStatus.sErrorFlag.streetnumber}instyle_error{/if}" />
                                    </div>
                            ...
                            <div class="form_row">
                                <input type="submit" value="{s name=sNewsletterButton}{/s}" class="btn save full" />
                            </div>
