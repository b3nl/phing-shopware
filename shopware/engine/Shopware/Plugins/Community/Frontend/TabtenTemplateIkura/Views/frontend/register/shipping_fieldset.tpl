<fieldset class="alternative_shipping">
    ...
    <div class="row">
        ...
        {block name='frontend_register_shipping_fieldset_input_street'}
            <div class="form_row col two">
                ...
                <input name="register[shipping][streetnumber]" type="text"  id="streetnumber2" value="{$form_data.streetnumber|escape}"  maxlength="5" class="streetnumber text required {if $error_flags.streetnumber}instyle_error{/if}" />
            </div>
        {/block}
    ...
    <div class="row">
        ...
        {block name='frontend_register_shipping_fieldset_input_country_states'}
            <div class="country-area-state-selection form_row col two">
                {if !$country.states}&nbsp;{/if}
