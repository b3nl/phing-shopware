...
{elseif $sBasketItem.modus == 2}
	<div class="table_row row voucher">
		<div class="col two">
		...
		<div class="action">
			<a href="{url action='deleteArticle' sDelete=voucher sTargetAction=$sTargetAction}" class="del" title="{s name='CartItemLinkDelete'}{/s}">x</a>
		</div>
		{/block}
	</div>
...
<div class="table_row row rebate">
...
{elseif $sBasketItem.modus == 1}
	<div class="table_row row selected_premium">
		<div class="col first">
...
{elseif $sBasketItem.modus == 4}
	<div class="table_row row small_quantities">
...
{elseif $sBasketItem.modus == 10}
	<div class="table_row row bundle_row">
