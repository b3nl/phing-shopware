...
<div id="center" class="addresses">
    <div class="inner">
        {if $sBillingAddresses}
            <h2>{se name="SelectBillingHeader"}{/se}</h2>
        ...
        {block name="frontend_account_select_billing_action_buttons"}
            <a class="btn neutral" href="{if $sTarget}{url controller=$sTarget}{else}{url controller='account'}{/if}" title="{s name='SelectBillingLinkBack'}{/s}">
