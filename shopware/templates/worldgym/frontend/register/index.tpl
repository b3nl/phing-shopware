...
{block name="frontend_index_content"}
	<div class="register" id="center">
        <div class="inner">
            ...
            <form class="form register" method="post" action="{url action=saveRegister}">
                ...
                {if !$update}
                    {if {config name=ACTDPRCHECK}}
                        {block name='frontend_register_index_input_privacy'}
                            <div class="privacy form_row col twothirds">
                ...
                <div class="required_fields col two">
                    {s name='RegisterPersonalRequiredText' namespace='frontend/register/personal_fieldset'}{/s}
                </div>

                <div class="form_row col two textright">
                    <input id="registerbutton" type="submit" class="btn" value="{s name='RegisterIndexActionSubmit'}{/s}" />
                </div>
            </form>
        </div>
	</div>
