<div id="commentcontainer">
	...
	{/if}
	<h2>{se name="BlogHeaderWriteComment"}{/se}</h2>
	<form method="post" action="{url controller=blog action=rating blogArticle=$sArticle.id}" class="comments form">
		...
		{* Submit button *}
        <div class="col one">
            <input class="btn textright" type="submit" name="Submit" value="{s name='BlogLinkSaveComment'}{/s}" />
