                ...
                <div class='article_details_bottom'>
                    ...
                    <div {if $sArticle.pseudoprice} class='article_details_price2'>{else} class='article_details_price'>{/if}
                        ...
                        <div class="PseudoPrice{if $sArticle.sVariants} displaynone{/if}">
                            <span>{s name="reducedPrice" namespace="frontend/listing/box_article"}{/s} {$sArticle.pseudoprice|currency} {s name="Star" namespace="frontend/listing/box_article"}{/s}</span>
