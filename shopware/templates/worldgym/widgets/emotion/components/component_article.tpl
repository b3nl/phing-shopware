...
{block name='frontend_listing_box_article_picture'}
	...
	<a href="{$sArticle.linkDetails|rewrite:$sArticle.articleName}" title="{$sArticle.articleName}" class="artbox_thumb">
        ...
        {/if}
	    {if !isset($sArticle.image.src)}
            <img class="lazy" src="{link file="frontend/_resources/images/css/bg.gif"}" data-src="{link file='frontend/_resources/images/no_picture.jpg'}" alt="{s name='ListingBoxNoPicture'}{/s}" />
        {/if}
    </a>
{/block}
